...
git branch -a
# List all of the branches in your repository, including remote branches.

git branch <branch>
# Create a new branch called <branch>. This does not check out the new branch.

git push -u origin <branch>
# Push the local branch <branch> to the remote repository (named origin).
# The -u option sets up tracking between the local and remote branches, so pull and push work without specifying the branch name.
