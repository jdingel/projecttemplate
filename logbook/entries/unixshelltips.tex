...
Nano, Emacs, and Vim will typically be installed everywhere, so it's worth knowing some basic info.
...
Read the \href{https://columbiauniversity.atlassian.net/wiki/spaces/rcs/pages/62145124/Insomnia+HPC+Cluster+User+Documentation}{Columbia HPC introduction} and then head over to the \href{https://slurm.schedmd.com/overview.html}{official documentation}.
...
\begin{itemize}
	...
	\item Typing \texttt{open .} in any directory in the Terminal will open that folder in the Finder (via Florian Oswald's tweet)
\end{itemize}
